      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md">
          <div className="flex flex-col space-y-2 py-4 px-6">
            <Link to="/" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-green-600">Home</Link>
            ...
            <Link to="/profile" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-green-600">Profile</Link>
          </div>
        </div>
      )}
    </nav>
